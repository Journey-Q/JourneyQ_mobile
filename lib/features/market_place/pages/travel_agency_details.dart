                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'LKR ${((vehicle['acPricePerKm'] ?? 50) * 50).toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} for 50km',
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: Colors.green.shade700,
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        'LKR ${((vehicle['nonAcPricePerKm'] ?? 40) * 50).toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} for 50km',
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: Colors.orange.shade700,
