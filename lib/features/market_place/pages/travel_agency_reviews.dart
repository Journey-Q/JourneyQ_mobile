...
class _TravelAgencyReviewsPageState extends State<TravelAgencyReviewsPage> {
  ...
  Future<void> _loadReviewsData() async {
    try {
      print('🏢 Loading reviews for agency ID: ${widget.agencyId}');
      ...
      // Load all reviews
      final agencyReviews = await ReviewRepository.getReviewsByServiceProviderId(widget.agencyId);
      ...
      print('❌ Error loading agency reviews: $e');
